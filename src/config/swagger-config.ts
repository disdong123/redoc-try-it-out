import {
  CallbackFunction,
  SwaggerOptions,
} from "../interfaces/swagger-options.interface";
...
export class SwaggerConfig implements SwaggerOptions {
  ...
  private readonly _authorizeBtnSelector: string =
    ".swagger-ui .auth-wrapper .authorize";
  private readonly _authorizeDoneBtnSelector: string =
    ".swagger-ui .auth-btn-wrapper .btn-done";
  private readonly _authorizeModalCloseBtnSelector: string =
    ".swagger-ui .dialog-ux .modal-ux-header .close-modal";
  private readonly _authorizeModalSelector: string =
    ".swagger-ui .dialog-ux .modal-ux";
  private readonly _modalOverlaySelector: string = ".swagger-ui .dialog-ux";

  private readonly _operationSectionContainerSelector: string =
    ".swagger-ui .opblock-tag-section";
  private readonly _operationContainerSelector: string = ".swagger-ui .opblock";
  private readonly _operationSummaryPatternSelector: string =
    '.swagger-ui .opblock .opblock-summary-{method} [data-path="{api}"]';
